 ...
 * Package Name:com.arvin.tools
 * Date:2014年5月14日下午7:25:40
...
public class FileUtils {
	private String TAG = "com.arvin.tools.FileUtils";
	/**
	 * sd卡的根目录
	 */
	...
	public void savaBitmap(String fileName, Bitmap bitmap) throws IOException {
		...
		Log.i(TAG, "savaBitmap - path:" + path);
