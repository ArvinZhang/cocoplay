...
/**
 * ClassName:Mp3Loader Function: TODO ADD FUNCTION. Reason: TODO ADD REASON.
...
public class Mp3Loader {
	...
	private Mp3DBManager mp3dbm = Mp3DBManager.getInstance(MyApplication
			.getInstance());
...
//				Log.i(TAG, cursor.getString(cursor.getColumnIndex(MediaStore.Audio.Media.TITLE)) + "----" + i++);
	...
	private Mp3Loader() {
		...
		sp = MyApplication.getInstance().getSharedPreferences(SP_NAME,
